...
function Footer() {
    return (
      <footer className=" w-full pt-12 ">
          <div className="flex justify-between max-w-6xl mx-auto  sm:grid-cols-2  sm:px-6 lg:px-8">
          
          <div>
            <h2 className=" text-lg font-semibold mb-4">About </h2>
            <ul>
            <li className="font-normal text-xs leading-26">
              <a href="#" className="hover:underline transition-colors duration-300 leading-5">
                 About Us
               </a>
             </li>
             <li className="font-normal text-xs leading-26">
          ...
          <div>
            <h2 className=" text-lg font-semibold mb-4">Resources & Links</h2>
            <ul>
            <li className="font-normal text-xs leading-26">
            <a href="#" className="hover:underline transition-colors duration-300 leading-5">
                 Asbestos fact sheet
              ...
              <li className="font-normal text-xs leading-26">
              <a href="#" className="hover:underline transition-colors duration-300 leading-5">
                  Understanding facade fire compliance
                </a>
              </li>
              <li className="font-normal text-xs leading-26">
              <a href="#" className="hover:underline transition-colors duration-300 leading-5">
          ...
          <div>
            ...
            <li className="font-normal text-xs leading-26">
            <a href="#" className="hover:underline transition-colors duration-300 leading-5">
                 myHardies™ Industry Professionals
                </a>
              </li>
              <li className="font-normal text-xs leading-26">
              <a href="#" className="hover:underline transition-colors duration-300 leading-5">
