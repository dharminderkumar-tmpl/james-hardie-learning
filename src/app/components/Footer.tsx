...
function Footer() {
  return (
    <footer className=" w-full pt-12 max-sm:hidden">
        ...
        <div>
          ...
          <ul>
            <li className="font-normal text-xs leading-26">
              <a
                href="#"
                className="hover:underline transition-colors duration-300 leading-5"
              >
                About Us
              </a>
            </li>
        ...
        <div className="flex items-center gap-5">
          <div className="flex gap-5 items-center">
            ...
            <div className="flex gap-3">
              <h3 className="hover:underline transition-colors duration-300 leading-5 text-xs">
                North America |{" "}
              </h3>
      ...
      <div className="flex justify-between items-center pr-10 pl-10 pb-10 bg-[#343B4E]">
        ...
        <div className="flex gap-2">
          <h3 className="text-center text-xs pt-8 text-white">
            Terms and Condition |{" "}
          </h3>
          <h3 className="text-center text-xs pt-8 text-white">
            Service Offer |
