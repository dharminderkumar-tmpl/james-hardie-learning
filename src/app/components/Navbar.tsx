  ...
  return (
    <div className={cn("fixed top-0 inset-x-0 w-full flex  ", className)}>
      ...
      <Menu  setActive={setActive}>
        ...
        <MenuItem setActive={setActive} active={active} item="Products" ></MenuItem></Link>
        ...
        <Link href="/resources">
        <MenuItem setActive={setActive} active={active} item="Resources"></MenuItem></Link>
        <Link href="/homeguide">
        <MenuItem setActive={setActive} active={active} item="Home Guide"></MenuItem></Link>
    ...
    <button className="bg-green-700 hover:bg-green-900 text-white pl-5 pr-9 pt-5 pb-5 mx-auto flex justify-center font-semibold font-montserrat text-lg leading-5 items-center ">
        <h2>myHardie™|</h2>
